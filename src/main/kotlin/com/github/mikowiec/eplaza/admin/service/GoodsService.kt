...
interface GoodsService {
    ...
    fun findByGoodsNameAndPage(goodsName: String, page: Int, pageSize: Int, orderKeys: String): List<Goods>
    ...
    fun findByPage(offset: Int, pageSize: Int, orderKeys: String): List<Goods>
